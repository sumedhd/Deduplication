        ...
        <!-- Brand and toggle get grouped for better mobile display -->
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
             <ul style="background-color:powderblue;" class="nav navbar-nav  navbar-right">
              <li class="active"><a href="UserView.jsp"><b>Home </b><span class="sr-only">(current)</span></a></li>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                  <h4 class="text-upper">Search File</h4>
                 <br>
                  <form class="subscription-form" action="ViewFiles.jsp" method="post">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" name="filekey" id="exampleInputEmail1" placeholder="Enter File key">
                    </div>
                    
                    <button type="submit" class="btn btn-orange border-none btn-rounded-corner">Search<span class="icon-on-button"></span></button>
