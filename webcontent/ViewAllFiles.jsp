            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                 <h4 class="text-upper col-md-offset-2">All File Details Table</h4><br>
                   <form class="subscription-form">
                    ...
                    <tr class="danger" style="color:black">
                     ...
                     while(rs.next())
                     {
                    	 ...
                    	 <td><a href="KeyRequestController?id=<%=rs.getString(1)%>&filename=<%=rs.getString(2)%>&file=<%=rs.getString(3)%>&filekey=<%=rs.getString(4)%>">Key Request</a></td>
