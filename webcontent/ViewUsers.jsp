            ...
            <div class="row">
              <div class="col-md-8 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                  <h4 class="text-upper col-md-offset-6"><center>Data Holder Details Table</center></h4><br>
                   <form class="subscription-form">
                    ...
                    <th> Name   </th>
                     ...
                     ResultSet rs=st.executeQuery("select id,name,email,password,mobileno,address,gender,dob,status from tbl_dataholder");
                     while(rs.next())
                     {
                    	 %>
                    	 <TR>
                    	 ...
                    	 <td><a href="UserDeleteController?name=<%=rs.getString(2)%>&email=<%=rs.getString(3)%>&password=<%=rs.getString(4)%>&mobileno=<%=rs.getString(5)%>&address=<%=rs.getString(6)%>&gender=<%=rs.getString(7)%>&dob=<%=rs.getString(8)%>&status=<%=rs.getString(9)%>">Delete</a></td>
                    	 </TR>
