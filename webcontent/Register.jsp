        ...
        <!-- Brand and toggle get grouped for better mobile display -->
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul style="background-color:powderblue;" class="nav navbar-nav  navbar-right">
              ...
              <li class="active"><a href="#home"><b>Home</b> <span class="sr-only">(current)</span></a></li>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                  <h4 class="text-upper">Data Holder Registration</h4>
                  <p>If you have Registerd Data Holder <a href="Register.jsp">Click Here ?</a></p>
                  <form class="subscription-form" action="UserRegisterController" method="post">
