            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                  <h4 class="text-upper">Forgot Password</h4>
                 
                  <form class="subscription-form" action="ForgotPasswordController" method="post">
                    ...
                    <button type="submit" class="btn btn-orange border-none btn-rounded-corner">Submit<span class="icon-on-button"></span></button>
