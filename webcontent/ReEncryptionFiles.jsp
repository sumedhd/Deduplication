          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
           <ul style="background-color:powderblue;" class="nav navbar-nav  navbar-right">
              <li class="active"><a href="Home.jsp"><b>Home</b> <span class="sr-only">(current)</span></a></li>
                <li><a href="CloudAFiles.jsp"><b>View Uploaded Files</b></a></li>
                 <li><a href=""><b>Proxy Re-Encryption</b></a></li>
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 padding-top-bottom-90">
                <div class="subscription-wraper text-center">
                 <h4 class="text-upper col-md-offset-1">Files Details Table</h4><br>
                   <form class="subscription-form">
                    ...
                    <tr class="danger" style="color:black">
                     ...
                     session1.setAttribute("downloadFilePathSession", filename);
                     while(rs.next())
                     {
                    	 %>
                    	 <TR>
                    	 ...
                    	 <td><%=rs.getString(2) %></td>
                    	  <td><%=rs.getString(3) %></td>
                    	   <td><a href="ProxyEncryptionController?filename=<%=rs.getString(2)%>">Re-Encryption</a></td>                 	 
                    	 </TR>
